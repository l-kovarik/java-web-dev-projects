...
public class CD extends Media implements Rewritable{
    ...
    public void writeFile(File file) {
        ...
        if (getFiles().contains(file)) {
            System.out.println("The filetype is " + fileType + " " + file.getName() + " has already been added.");
    ...
    public void removeFile(File file) {
        if (isMusicCD) {
            System.out.println("Individual files cannot be removed from a CD once written.");
        } else {
            spinDisc();
